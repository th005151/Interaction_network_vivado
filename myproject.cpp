...
#pragma HLS INTERFACE ap_vld port=N,E,receivers,senders,e
 ...
 if (!loaded_weights) {
  ...
  nnet::relational_model<input_t, index_t, input_t, graph_config1>(0,0*N_EDGES_MAX/4,4*N_EDGES_MAX/4,E_rep[0], N_rep[0], receivers_rep[0], senders_rep[0], effects, aggregation_tmp[0], core_edge_w0, core_edge_b0, core_edge_w1, core_edge_b1, core_edge_w2, core_edge_b2, core_edge_w3, core_edge_b3);
...
//--------------------------------------------------------------------------- 
  ...
  nnet::relational_model<input_t, index_t, input_t, graph_config3>(0,0*N_EDGES_MAX/4, 4*N_EDGES_MAX/4, effects_rep[0], influence_rep[0], receivers, senders, e, q_tmp[0], core_edge_w0, core_edge_b0, core_edge_w1, core_edge_b1, core_edge_w2, core_edge_b2, core_edge_w3, core_edge_b3);
