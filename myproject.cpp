...
#pragma HLS INTERFACE ap_vld port=N,E,receivers,senders,e
 ...
 if (!loaded_weights) {
  ...
  nnet::relational_model<input_t, index_t, input_t, graph_config1>(E, N, receivers, senders, effects, core_edge_w0, core_edge_b0, core_edge_w1, core_edge_b1, core_edge_w2, core_edge_b2, core_edge_w3, core_edge_b3);
...
//--------------------------------------------------------------------------- 
  ...
  nnet::relational_model<input_t, index_t, input_t, graph_config3>(effects, influence, receivers, senders, e,  core_edge_w0, core_edge_b0, core_edge_w1, core_edge_b1, core_edge_w2, core_edge_b2, core_edge_w3, core_edge_b3);
